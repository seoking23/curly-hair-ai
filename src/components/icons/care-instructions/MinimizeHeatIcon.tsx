...
interface MinimizeHeatIconProps extends IconBaseProps {}

export const MinimizeHeatIcon: React.FC<MinimizeHeatIconProps> = ({
  color = '#6D4C41',
  accessibilityLabel = 'Minimize heat styling to prevent further damage',
  ...props
}) => {
  return (
